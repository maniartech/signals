...
|---|--------|-------------------------|----------|
| 1 | **[Dispatch](#family-1--dispatch)** | How is an emission delivered to listeners? | Synchronous Sequential · Reverse (LIFO) · Short-Circuit · Fire-and-Forget · Await-All |
...
| Let a listener stop the chain early so later listeners don't run | [Short-Circuit Dispatch](dispatch/short-circuit-dispatch.md) |
