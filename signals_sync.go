...
// Emit is a method on the SyncSignal struct.
// It notifies all subscribers of the signal and passes the payload.
...
// Unlike the AsyncSignal's Emit method, this method does not call the listeners in separate goroutines,
// so the listeners are called synchronously, one after the other.
